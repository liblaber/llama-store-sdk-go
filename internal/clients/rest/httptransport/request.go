...
import (
	...
	"github.com/liblaber/llama-store-sdk-go/internal/utils"
...
type Request struct {
	...
	Options     any
	Body        any
	Config      llamastoreconfig.Config
}

func NewRequest(ctx context.Context, method string, path string, config llamastoreconfig.Config) Request {
	return Request{
		Context:     ctx,
		Method:      method,
		Path:        path,
